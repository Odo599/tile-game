...
if global.yellow_timer > (global.yellow_timer_time - 1)
{
	...
	{
		instance_create_layer(left_pixel, y, "Tiles", obj_tile_yellow)	
	...
	{
		instance_create_layer(right_pixel, y, "Tiles", obj_tile_yellow)	
		global.yellow_timer = 0;
	}
	...
	{
		instance_create_layer(x, above_pixel, "Tiles", obj_tile_yellow)
		global.yellow_timer = 0;
	}
	...
	{
		instance_create_layer(x, below_pixel, "Tiles", obj_tile_yellow)
		global.yellow_timer = 0;
	}
}
